...
configure_system() {
    ...
    echo "10.0.0.21:/mnt/user/data /home/$USERNAME/data nfs _netdev,noauto,x-systemd.automount,x-systemd.mount-timeout=10,timeo=14,x-systemd.idle-timeout=1min 0 0" >> /etc/fstab
